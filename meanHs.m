% MATLAB script meanHs
%
% Alexandre Noll Marques
% MIT
%
% This script evaluates the mean of the multi-run model for H*, as
...
Hs_mean = meanPosteriorMultiRun(H, pos, 2);

disp('Writing values to file...')
filename = 'Hs_mean.txt';
fid = fopen(filename, 'w');
fprintf(fid, '%10.3e %10.3e\n', [H;Hs_mean']);

disp('meanHs finished succesfully')
